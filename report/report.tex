...
reach a local optimum for the initial population and would not improve past this.
...
As the value returned from a fitness function, with be specific to the domain it
has be used within, it is necessary to rescale the fitness value to ensure 
...
\lstinputlisting[language=python, 
                 caption=A Python implementation of a simple Genetic Algorithm, 
